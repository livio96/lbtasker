...
<html class="no-js" lang="en">
  <head>
    ...
    <title>My Account || ShareMaster</title>
  ...
  <body>
    ...
    <nav class="top-bar" data-topbar role="navigation">
      <ul class="title-area">
        <li class="name">
          <h1><a href="index.php">ShareMaster</a></h1>
        </li>
    ...
    <div class="row" style="margin-top:30px;">
      <div class="small-12">
        ...
        <p><strong> If you wish to make any changes to your account details, then just enter new data and click on update.</strong></p>
      </div>
    </div>
            ...
            <div class="small-8 columns end">
              <?php
                ...
                if($result) {
                  ...
                  echo '<input type="text" id="right-label"  name="fname">';
                  ...
                  echo '<input type="email" id="right-label" name="email">';
